  ...
  return (
    <div className="events-page">
      ...
      <div className="content">
        ...
        <MotionUp delay={0.4}>
          <h5>
            Investor, Executive and Operator, Scott is the VP-Data Operations
            for pharma-tech venture-backed startup, Redica Systems. He was
            previously the COO of Aumni (a JP Morgan company). With over 15
            years of leadership experience spanning operations, data, legal, and
            customer experience, he brings with him a strong track record of
            driving business growth and operational efficiency. He will talk
            about how a countryside talent can thrive successfully in
            fast-paced, venture-backed, high-growth startups.
          </h5>
        </MotionUp>
        <h6>
