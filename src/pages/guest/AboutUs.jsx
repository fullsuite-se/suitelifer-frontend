...
const AboutUs = () => {
  return (
    <section className="">
      ...
      <main className="overflow-hidden about-container">
        ...
        <section className="flex flex-col gap-3 mt-5 mx-5">
          ...
          <p className="text-lg leading-tight">
            FullSuite is the preferred and trusted offshore service provider to
            help data-intense tech companies scale operations and revenue at a
          ...
          <p className="text-sm">
            ...
            preferred and trusted offshore service provider to help data-intense
            tech companies scale operations and revenue at a fraction of the
            cost of traditional staffing. FullSuite is the preferred and trusted
            offshore service provider to help data-intense tech companies scale
            operations and revenue at a fraction of the cost of traditional
            staffing. FullSuite is lorem ipsum the preferred and trusted
            offshore service provider to help data-intense.
          </p>
        </section>
        <section className="">
