...
>
  ...
  <div className="relative">
        ...
        <div className="absolute bottom-0 p-4 text-white">
          <h2 className="font-sansita-extra-bold !text-[14px] lg:!text-[16px] group-hover:text-secondary group-hover:font-sansita-extra-bold  transition duration-300 ease-in-out line-clamp-2">
            {title}
          </h2>
