    ...
    <section>
      ...
      >
        <div className="lg:w-1/2 flex flex-col justify-center">
          {/* Title */}
          <p className="group-hover:!text-primary transition-all duration-200 line-clamp-2 text-lg lg:text-2xl font-avenir-black xl:text-4xl">
            {title}
          </p>
          ...
          <div className="hidden lg:block">
            <p className="text-lg lg:line-clamp-6 lg:overflow-hidden text-gray-400 font-avenir">
              {article.replace(/<[^>]+>/g, "")}
            </p>
        ...
        {/* Article */}
        <article className="text-sm lg:hidden line-clamp-4 md:line-clamp-6 lg:line-clamp-1 lg:overflow-hidden text-gray-500 font-avenir">
          {article.replace(/<[^>]+>/g, "")}
        </article>
      </NavLink>
    </section>
